...
import { IMyDate, IMyMonth, IMyWeek, IMyOptions, IMyDateModel, IMyInputAutoFill, IMyInputFieldChanged, IMyCalendarViewChanged } from "./interfaces/index";
...
export declare class MyDatePicker implements OnChanges, ControlValueAccessor {
    ...
    MAX_YEAR: number;
    opts: IMyOptions;
    constructor(elem: ElementRef, renderer: Renderer, localeService: LocaleService, utilService: UtilService);
